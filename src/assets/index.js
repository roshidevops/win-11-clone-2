  ...
  images: {
    icons: {
      apps: {
        ...
        winCMD: imagesIconsApps("win-cmd.jpeg"),
        ...
        x: imagesIconsApps("x.png"),
        edge: imagesIconsApps("edge.png"),
        apple: imagesIconsApps("apple.webp"),
        CryptoTracker: imagesIconsApps("bitcoin.webp"),
      },
    },
    profiles: {
      tanvi: imagesProfiles("tanvi.gif"),
    },
    wallpapers: [
      ...
      imagesWallpapers("7.jpg"),
      imagesWallpapers("8.png"),
      imagesWallpapers("9.png"),
    ],
  },
};
