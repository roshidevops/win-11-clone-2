...
const CommandLineApp = ({
  ...
  const onKeydownTerminalInput = (e) => {
    if (e.key === "Enter") {
      ...
      if (command === "github") {
        window.open("https://github.com/shindodkar", "_blank", WIN_FEATURES);
      ...
      if (command === "Apple Store") {
        window.open(
          "https://iphone-15-pro-lyart.vercel.app/",
          "_blank",
          WIN_FEATURES
        );
        output = "Opening Apple Store";
      ...
      if (command === "help" || command === "?") {
        output = (
          <p>
            ...
            X - open X <br />
            Apple Store - open Apple Store <br />
  ...
  return (
    ...
    >
      <div
        ...
        className="inverse-toggle absolute z-10 overflow-hidden rounded-md bg-black font-mono text-sm leading-normal text-gray-100 subpixel-antialiased shadow-lg"
      >
        <div className="flex items-center justify-between bg-transparent bg-gray-700">
          <div
        ...
        <div className="h-full overflow-scroll px-2 pb-10 ">
          <p className="mb-2">
            Microsoft Windows [version 10.0.22631.4169] <br />
          ...
          <div className="flex">
            <span className="text-white">{currentTerminalDirectory}&gt;</span>
            <input
