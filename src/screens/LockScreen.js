  ...
  return (
    <>
        ...
        <div className="h-screen w-screen">
          <div>
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="mt-40 flex w-72 flex-col items-center text-xl font-semibold">
                Did you know?
        ...
        >
          <div className="mt-28 flex flex-col items-center justify-center">
            <img
              ...
              alt="User Profile"
            />
            <h1 className="mt-4 text-2xl font-semibold">Tanvi Shindodkar</h1>
            {loginIsSuccess ? (
      ...
      {helpForgotPIN && (
        ...
        >
          <NotificationFrom
            from="Tanvi Shindodkar"
            image={profiles.tanvi}
            message={
              <>
                Hello There!
